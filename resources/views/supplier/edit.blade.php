                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label>Name</label>
                            <textarea name="name" class="form-control">{{ $supplier->name}}</textarea>
                        ...
                        <div class="form-group">
                            <label>Email</label>
                            <textarea name="email" class="form-control">{{ $supplier->email}}</textarea>
                        ...
                        <div class="form-group">
                            <select name="city_id" class="form-control select2" data-toggle="select2" id="city"
                                    required>
                                <option value="{{$supplier->city_id}}">
                                    @foreach($city_name as $i)
                                        @if($i->id === $supplier->city_id ? 'selected' : '')
                                            {{$i->name}}
                                        @endif
                                    @endforeach
                                </option>
                        ...
                        <div class="form-group">
                            <select name="district_id" class="district form-control select2" data-toggle="select2"
                                    required>
                                <option selected value="{{$supplier->district_id}}">
                                    @foreach($district_name as $i)
                                        @if($i->id == $supplier->district_id)
                                            {{$i->name}}
                                        @endif
                                    @endforeach
                                </option>
                        ...
                        <div class="form-group">
                            <select name="wards_id" class="form-control select2" data-toggle="select2" id="ward"
                                    required>
                                <option selected value="{{$supplier->wards_id}}">
                                    @foreach($ward_name as $i)
                                        @if($i->id == $supplier->wards_id)
                                            {{$i->name}}
                                        @endif
                                    @endforeach
                                </option>
